...
class ManyToManyBackendTestCase(ArmSectionsTestCase):
    ...
    @override_settings(ARMSTRONG_SECTION_ITEM_MODEL='tests.arm_sections_support.models.Common')
...
class ForeignKeyBackendTestCase(ArmSectionsTestCase):
    ...
    @override_settings(ARMSTRONG_SECTION_ITEM_MODEL='tests.arm_sections_support.models.SectionForeignKeyCommon')
